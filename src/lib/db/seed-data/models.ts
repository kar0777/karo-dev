...
export const PROVIDER_SEEDS: readonly ProviderSeed[] = [
  ...
  },
  {
    ...
    metadata: {
      ...
      note: 'The Claude family first-hand on the native Messages protocol. Tool calling and cache usage are first-class.',
    },
  },
  {
    key: 'hypercli',
    ...
    healthStatus: 'disconnected',
    metadata: {
      docs: 'https://docs.hypercli.com/agents/integrations',
      protocol: 'anthropic-messages',
      credential: 'HYPERCLI_API_KEY',
      note: 'Flat-rate Kimi K3 (daily token allowance) on the Anthropic Messages route its docs recommend for tool calling.',
    },
  },
  {
    key: 'mock',
...
export const MODEL_SEEDS: readonly ModelSeed[] = [
  ...
  },
  {
    ...
    family: 'minimax',
    description:
      'Multimodal and coding/agent-focused with a full 1M-token context, at under $1/Mtok out — the whole repository fits in one prompt.',
